...
void MinuitOptimizer::FitPointDirectionWithMinuit() {
  ...
  fMinuitPointDirection->mnparm(0,"theta",seedTheta,0.0277*TMath::Pi(),0.0,TMath::Pi(),err);
...
void MinuitOptimizer::FitExtendedVertexWithMinuit() {
  ...
  fMinuitExtendedVertex->mnparm(4, "phi", seedPhi, 0.025 * TMath::Pi(), 0, 0.5 * TMath::Pi(), err);//-2.0*TMath::Pi(), 2.0*TMath::Pi(),err);
