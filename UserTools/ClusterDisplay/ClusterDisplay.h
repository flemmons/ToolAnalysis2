...
class ClusterDisplay: public Tool {
 ...
 public:
  ...
  void make_gui();
  void draw_event(int clusterNumber);
  void draw_cluster_box(int clusterNumber);
  ...
  void draw_clusters(int clusterNumber);
  void collect_digits();
 ...
 private:
    ...
    std::vector<RecoCluster*>* RecoClusters = nullptr;
    ...
    std::string filename_evdisplay;
    std::string filename_pmts;
    std::string filename_pmts2D;
    std::string filename_lappds;
